...
================================================
指标ID: IND_WLK_RAT
指标名称: Visual Walkability Ratio (步行性比值)
类型: TYPE B (two_class_ratio模式)

说明:
计算街景图像中“行人导向要素”（铺装 sidewalk、围栏 fence）
与“机动车道路要素”（road）之间的像素比值，用于表征视觉层面的步行友好程度。

公式:
IND_WLK_RAT = (Pavement_pixels + Fence_pixels) / Road_pixels
"""
...
def calculate_indicator(image_path: str) -> Dict:
    """
    计算 Visual Walkability Ratio (IND_WLK_RAT)
